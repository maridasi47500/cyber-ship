...
class JobpostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create jobpost" do
    assert_difference("Jobpost.count") do
      post jobposts_url, params: { jobpost: { content: @jobpost.content, pic: @jobpost.pic, title: @jobpost.title, user_id: @jobpost.user_id } }
    end
  ...
  test "should update jobpost" do
    patch jobpost_url(@jobpost), params: { jobpost: { content: @jobpost.content, pic: @jobpost.pic, title: @jobpost.title, user_id: @jobpost.user_id } }
